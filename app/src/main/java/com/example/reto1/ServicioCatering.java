...
public class ServicioCatering extends AppCompatActivity {
    ...
    String NombreCita= "Servicio Catering";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_servicio_catering);
        ...
        Button botonAtras=findViewById(R.id.atrasCatering); //  Para volver a la pantalla anterior
                ...
                usersRef.addSnapshotListener(new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(@Nullable QuerySnapshot querySnapshot, @Nullable FirebaseFirestoreException error) {
                        ...
                        for (QueryDocumentSnapshot document: querySnapshot){
                            if(document.getDate("fechaCitaSC1")!=null){ //Si la fecha no es null
                                // Log.d("TAG","OL fechas");
                                Date fechaCita = document.getDate("fechaCitaSC1");  //Recoge la fecha
                            ...
                            if(document.getDate("fechaCitaSC2")!=null){
                                Date fechaCita = document.getDate("fechaCitaSC2");
                            ...
                            if(document.getDate("fechaCitaSC3")!=null){
                                Date fechaCita = document.getDate("fechaCitaSC3");
                                citaOL.getArrayFechas().add(String.valueOf(fechaCita));

                                radioButtonB3.setVisibility(View.VISIBLE);
                                radioButtonB3.setText(String.valueOf(fechaCita));
                            }
                            if(document.getDate("fechaCitaSC4")!=null){
                                Date fechaCita = document.getDate("fechaCitaSC4");
                                citaOL.getArrayFechas().add(String.valueOf(fechaCita));

                                radioButtonB4.setVisibility(View.VISIBLE);
                                radioButtonB4.setText(String.valueOf(fechaCita));
                            }
                            if(document.getDate("fechaCitaSC5")!=null){
                                Date fechaCita = document.getDate("fechaCitaSC5");
                                citaOL.getArrayFechas().add(String.valueOf(fechaCita));
