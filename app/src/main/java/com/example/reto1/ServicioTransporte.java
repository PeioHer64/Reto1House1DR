...
public class ServicioTransporte extends AppCompatActivity {
    ...
    String NombreCita= "Servicio Transporte";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_servicio_transporte);
        ...
        Button botonAtras=findViewById(R.id.atrasTransporte); //  Para volver a la pantalla anterior
                ...
                usersRef.addSnapshotListener(new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(@Nullable QuerySnapshot querySnapshot, @Nullable FirebaseFirestoreException error) {
                        ...
                        for (QueryDocumentSnapshot document: querySnapshot){
                            if(document.getDate("fechaCitaST1")!=null){ //Si la fecha no es null
                                // Log.d("TAG","OL fechas");
                                Date fechaCita = document.getDate("fechaCitaST1");  //Recoge la fecha
                            ...
                            if(document.getDate("fechaCitaST2")!=null){
                                Date fechaCita = document.getDate("fechaCitaST2");
                            ...
                            if(document.getDate("fechaCitaST3")!=null){
                                Date fechaCita = document.getDate("fechaCitaST3");
                                citaOL.getArrayFechas().add(String.valueOf(fechaCita));

                                radioButtonB3.setVisibility(View.VISIBLE);
                                radioButtonB3.setText(String.valueOf(fechaCita));
                            }
                            if(document.getDate("fechaCitaST4")!=null){
                                Date fechaCita = document.getDate("fechaCitaST4");
                                citaOL.getArrayFechas().add(String.valueOf(fechaCita));

                                radioButtonB4.setVisibility(View.VISIBLE);
                                radioButtonB4.setText(String.valueOf(fechaCita));
                            }
                            if(document.getDate("fechaCitaST5")!=null){
                                Date fechaCita = document.getDate("fechaCitaST5");
                                citaOL.getArrayFechas().add(String.valueOf(fechaCita));
